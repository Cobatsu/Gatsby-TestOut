    ...
    <div className={styles.inner_container}>
     ...
     <div>
      ...
      <span className={styles.content} style={{lineHeight: 1.6}}>
       ...
       ‘assignment preparation’ session with one of our tutors. The session will
       be conducted via Zoom and cover all aspects of assignment writing,
     ...
     <div>
      ...
      <span className={styles.content} style={{lineHeight: 1.6}}>
       ...
       for External Verification. ATHE will then check all of the work to ensure
       it is of the correct standard. This process can take up to 30 working
       days. In total, once you have completed all assignments and had them
       marked, it can take up to 40 working days to receive your final result.
      </span>
     </div>
    </div>
    <div className={styles.inner_container}>
    ...
    <div className={styles.inner_container}>
     ...
     <div>
      ...
      <span className={styles.content} style={{lineHeight: 1.6}}>
       ...
       support, flexible delivery solutions, a global focus and a close business
       development relationship. Please visit athe.co.uk for more information
      </span>
     </div>
     <div>
