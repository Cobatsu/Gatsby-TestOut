            ...
            <div className={styles.footer_column_holder}>
                ...
                <div className={styles.footer_column}>
                    ...
                    <span style={{ marginBottom: 10 }}>
                        ...
                        <strong style={{ marginLeft: 25 }}> Canada : </strong>7030 Woodbine Avenue Markham, ON, Canada L3R 6G2<br />
                        <strong style={{ marginLeft: 25 }}>England : </strong> 12 Damson Walk, Nottingham, LG3 6NT
                    </span>
                    <span >
                        {" "}
