    ...
    return (
        <Layout title='Entry Requirements'>
            <div className={styles.detail_general_wrapper}>
                <div style={{ width: "73%" }}>
                    <h2 style={{ marginBottom: 80, fontSize: "2rem", color: "#191970" }}>FAQ</h2>
                    <div className={styles.inner_container}>
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                For students who do not live or come from an English language speaking
                                country, then we recommend taking an IELTS course to improve your
                                language to level 5.5 or higher. This can be done alongside our courses.
                                Your minimum level of English may vary depending upon which university
                                you decide to complete your top up qualification from.
                            </div>
                        </div>
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                ...
                                of the Richmond College course. You can study an English course
                                alongside the Richmond College course. At Level 4/5, you will require a
                                full secondary education to be eligible to enrol onto the course, and
                        ...
                        <div>
                            ...
                            <div className={styles.content}>
                                Learners should first visit the <Link to='/courses' > Richmond College Course page </Link>
                                to view the range of courses on offer. It’s important you choose a
                                subject you enjoy and will help you reach your goals. Here are some
                                things to consider when choosing the right subject for you: Review the
                                modules within the course: Do they interest you? Are they relevant to
                                your chosen career path? How is the course taught and assessed: Do you
                                have the motivation to study via distance learning? Are you able to work
                                independently? It is important that learners do not try to extend
                                themselves too far and too quickly, so should ideally choose a path that
                                comfortably moves on from their existing level of skills and experience.
                            </div>
                        </div>
                        <div>
                    ...
                    <div className={styles.inner_container}>
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                ...
                                ‘assignment preparation’ session with one of our tutors. The session
                                will be conducted via Zoom and cover all aspects of assignment writing,
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                ...
                                ‘Assignments’ area. Students must also provide a plagiarism report for
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                ...
                                assignment. You will not be penalised for going over this word count
                                limit as long as the work is related to the assignment question.
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                After an assignment has been submitted, our markers will return the
                                results within 10 working days. Once all assignments have been completed
                                and marked, an Internal Verifier will view the work, which usually takes
                                up to 10 working days. After the Internal Verification has come back and
                                agrees with the initial marking, all of the assignments are sent to ATHE
                                for External Verification. ATHE will then check all of the work to
                                ensure it is of the correct standard. This process can take up to 30
                                working days. In total, once you have completed all assignments and had
                                them marked, it can take up to 40 working days to receive your final
                                result.
                            </div>
                        </div>
                    </div>
                    <div className={styles.inner_container}>
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                Yes. Once Richmond College has received the cleared funds your course
                                material will be released to you immediately.
                            </div>
                        </div>
                        <div>
                            <h3> Is there any financial assistance available?</h3>
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                Richmond College offers an interest free payment plan so that you can
                                pay for your course over a set number of months. Contact one of our
                                student advisers for more information about this. UK students may also
                                be eligible for student loans for the university top-up programme.
                                Learners should make enquiries directly to their chosen university.
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                Payment can be made online through Sage Pay by credit/debit card, bank
                                transfer or PayPal through any of our international banks.
                            </div>
                        </div>
                        <div>
                    ...
                    <div className={styles.inner_container}>
                        ...
                        <div>
                            <h3>Who are ATHE?</h3>
                            <div className={styles.content} style={{ lineHeight: 1.6 }}>
                                ATHE provides colleges with qualifications in management, business,
                                tourism and health & social care, ATHE have made a name for themselves
                                with good customer service, rewarding qualifications and happy learners
                                with progression routes to university degrees. ATHE provide bespoke
                                training support, great value for money, comprehensive university
                                progressions, dedicated support from an ATHE officer, simple easy to use
                                documents and website, innovative qualifications, External Verifier
                                support, flexible delivery solutions, a global focus and a close
                                business development relationship. Please visit athe.co.uk for more
                                information
                            </div>
                        </div>
                        <div>
